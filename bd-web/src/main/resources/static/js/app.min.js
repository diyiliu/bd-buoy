		...
		activate:function(){
			...
			fixSidebar:function(){
				return $("body").hasClass("fixed")?(
					...
					void($.AdminLTE.options.sidebarSlimScroll&&"undefined"!=typeof $.fn.slimScroll&&(
							$(".sidebar").slimScroll({destroy:!0}).height("auto"),
							$(".sidebar").slimScroll({height:$(window).height()-$(".main-header").height()+"px",
		...
		$(document).off("click",a+" li a").on("click",a+" li a",function(a){
				...
				if(e.is(".treeview-menu")&&e.is(":visible")&&!$("body").hasClass("sidebar-collapse"))e.slideUp(c,function(){e.removeClass("menu-open")}),e.parent("li").removeClass("active");
						...
						e.slideDown(c,function(){
							...
							h.addClass("active"),b.layout.fix()
						})
				}
